...
```{r}
students <- read_csv("docs/data/students.csv")
```
...
```{r}
students <- read_csv("docs/data/students.csv", na = c("N/A", ""))
students
```
...
```{r}
students
write_csv(students, "docs/data/students-2.csv")
read_csv("docs/data/students-2.csv")
```
...
```{r}
write_rds(students, "docs/data/students.rds")
read_rds("docs/data/students.rds")
```
...
```{r}
library(arrow)
write_parquet(students, "docs/data/students.parquet")
read_parquet("docs/data/students.parquet")
```
